        ...
        <>
            ...
            {menuOpen && (
                <div className="md:hidden fixed inset-0 z-50 bg-paper flex flex-col px-6 py-5">
                    ...
                    <div className="mt-auto flex gap-5">
                        <a href="#" className="text-[13px] font-mono text-ink-soft">github</a>
                        <a href="#" className="text-[13px] font-mono text-ink-soft">linkedin</a>
                        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[13px] font-mono text-ink-soft">résumé ↗</a>
                    </div>
                </div >
            )
            }
            ...
            <aside className="hidden md:flex md:sticky md:top-0 md:h-screen border-r border-line px-9 py-14 flex-col justify-between">
                ...
                <div className="mt-auto flex gap-4 pt-10 border-t border-line">
                    <a href="#" className="text-[12px] font-mono text-ink-soft hover:text-coral transition-colors mt-4">github</a>
                    <a href="#" className="text-[12px] font-mono text-ink-soft hover:text-coral transition-colors mt-4">linkedin</a>
                    <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[12px] font-mono text-ink-soft hover:text-coral transition-colors mt-4">résumé ↗</a>
                </div>
            </aside >
        </>
    );
